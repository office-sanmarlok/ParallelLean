...
export function MeasurementPeriodModal({ isOpen, mvpNodeId, onClose }: MeasurementPeriodModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const mvpPos = typeof mvpNode.position === 'object' && mvpNode.position !== null
